...
e.$dots.find("li").eq(Math.floor(e.currentSlide/e.options.slidesToScroll)).addClass("slick-active").attr("aria-hidden","false"))},t.prototype.visibility=function(){var e=this;e.options.autoplay&&(document[e.hidden]?e.interrupted=!0:e.interrupted=!1)},e.fn.slick=function(){var e,n,i=this,o=arguments[0],r=Array.prototype.slice.call(arguments,1),s=i.length;for(e=0;e<s;e++)if("object"==typeof o||void 0===o?i[e].slick=new t(i[e],o):n=i[e].slick[o].apply(i[e].slick,r),void 0!==n)return n;return i}}),$(document).ready(function(){function e(e){e.preventDefault(),w.classList.toggle("toggler--close"),document.getElementById("nav").classList.toggle("nav--visible")}function t(e){e.preventDefault(),$(".modal").show(),$(".modal__close").one("click",n),$(".modal").on("click",i)}function n(){$(this).closest(".modal").hide()}function i(e){$(e.target).hasClass("modal")&&$(this).closest(".modal").hide()}function o(e){e.preventDefault(),$(".modal1").show(),$(".modal1__close").one("click",r),$(".modal1").on("click",s)}function r(){$(this).closest(".modal1").hide()}function s(e){$(e.target).hasClass("modal1")&&$(this).closest(".modal1").hide()}function a(e){e.preventDefault(),$(".modal2").show(),$(".modal2__close").one("click",l),$(".modal2").on("click",c)}function l(){$(this).closest(".modal2").hide()}function c(e){$(e.target).hasClass("modal2")&&$(this).closest(".modal2").hide()}function d(e){e.preventDefault(),$(".modal3").show(),$(".modal3__close").one("click",u),$(".modal3").on("click",p)}function u(){$(this).closest(".modal3").hide()}function p(e){$(e.target).hasClass("modal3")&&$(this).closest(".modal3").hide()}function f(e){e.preventDefault(),$(".modal4").show(),$(".modal4__close").one("click",h),$(".modal4").on("click",v)}function h(){$(this).closest(".modal4").hide()}function v(e){$(e.target).hasClass("modal4")&&$(this).closest(".modal4").hide()}function g(e){e.preventDefault(),$(".modal5").show(),$(".modal5__close").one("click",y),$(".modal5").on("click",m)}function y(){$(this).closest(".modal5").hide()}function m(e){$(e.target).hasClass("modal5")&&$(this).closest(".modal5").hide()}var w=document.getElementById("toggler");w.addEventListener("click",e),$(".tabs li").on("click",function(){$(this).addClass("active").siblings().removeClass("active");var e=$(this).attr("rel"),t=$("#"+e);t.siblings().hide(),t.addClass("d_active").fadeIn().siblings().fadeOut()}),$("dd").hide(),$(".accordion dt a").on("click",function(e){e.preventDefault();var t=$(this).parent().next();t.fadeIn(),$("dd").not(t).hide()}),$("#link").on("click",t),$("#link1").on("click",o),$("#link2").on("click",a),$("#link3").on("click",d),$("#link4").on("click",f),$("#link5").on("click",g),$("#nav").on("click","a",function(e){e.preventDefault();var t=$(this).attr("href"),n=$(t).offset().top;$("body,html").animate({scrollTop:n},1500)}),$(".tab_item").not(":first").hide(),$(".wrapper .tab").click(function(){$(".wrapper .tab").removeClass("active").eq($(this).index()).addClass("active"),$(".tab_item").hide().eq($(this).index()).fadeIn()}).eq(0).addClass("active"),$(".one-time").slick({dots:!0,infinite:!0,speed:300,slidesToShow:1,adaptiveHeight:!0,autoplay:!0,autoplaySpeed:2e3}),$(".responsive").slick({dots:!0,infinite:!0,speed:300,slidesToShow:5,slidesToScroll:5,responsive:[{breakpoint:7e3,settings:{slidesToShow:2,slidesToScroll:2,dots:!0}},{breakpoint:700,settings:{slidesToShow:1,slidesToScroll:1,dots:!0}}]})});